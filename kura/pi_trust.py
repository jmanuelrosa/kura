...
`kura trust` reads and writes `~/.claude.json`, and none of that applies here.
...
Why this is read at all: `kura add` creates `<project>/.agents/skills`, and pi
...
def prompt_reason(store, cwd, project, home=None):
    ...
    if skills is not None:
        ...
        trigger = "kura linked .agents/skills here" if ours else f"{skills} covers this directory"
    else:
