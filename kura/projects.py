...
def marks_a_project(directory):
    """Whether this directory looks like somewhere kura has installed.

    Either mark is enough. `kura.json` is the record, and `skills/` is what a
    ...
    return (claude / "skills").is_dir() or (claude / "kura.json").is_file()
